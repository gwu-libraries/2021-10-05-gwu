...
address: "Gelman Library, 2130 H Street, NW, Washington, DC 20052, Room 301-302"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
latitude: "38.8992362"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-77.0483541"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "October 5-6, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:30am - 4:30am EDT"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["Ann Myatt James", "Dan Kerchner", "Megan Potterbusch"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Leah Richardson"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["kerchner@gwu.edu","ajames31@gwu.edu", "mpotterbusch@gwu.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:  https://pad.carpentries.org/2021-10-05-gwu # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
...
<p id="who-can-attend">
  ...
  However, you MUST have GWorld tap access to Gelman Library in order to attend.  No visitors will be allowed into Gelman Library to attend this workshop.
</p>
{% elsif site.carpentry == "lc" %}
{% include lc/who.html %}
{% endif %}
